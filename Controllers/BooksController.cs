...
namespace F20_BookClub.Controllers
{
    ...
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BookId,BookName,BookNo,BookSeries,AuthorID")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookId,BookName,BookNo,BookSeries,AuthorID")] Book book)
        {
            if (id != book.BookId)
            {
                return NotFound();
